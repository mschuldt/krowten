...
//      *       store an item.)
//      */
//     protected HNode head;
//     protected int size;

//         /**
//      *  newNode() calls the HNode constructor.  Use this class to allocate
//      *  new HNodes rather than calling the HNode constructor directly.
...
//      */
//     protected HNode newNode(HNode next) {
//         return new HNode(next);
//     }
...
//         HNode node = newNode(entry, head, head.next);
//         node.next.prev = node;
//         head.next = node;
//         size++;
//     }
...
//      */
//     public HNode find(Object key){
//         HNode node = head.next;
//         while (node != head){
...
//      *  Performance:  runs in O(1) time.
//      */
//     public Entry remove(HNode node){

...
//     public Best minimax2(int side, int alpha, int beta, int depth){
...
//         int numPieces = board.getNumPieces(side);
//         PieceList pieces = board.getPieces(side);
...
//                         m.y1 = y;
//                         m.moveKind = Move.ADD;
//                         if (!board.formsIllegalCluster(m, side)){
//                             board.move(m,side);
...
//                                 myBest.move = new Move(x,y);
//                                 // myBest.move.x1 = x;
//                                 // myBest.move.y2 = y;
//                                 // myBest.move.moveKind = Move.ADD;
...
//                                 board.unMove(m);
//                                 if ((side == ourColor) && (score > myBest.score)){
//                                     myBest.move = new Move(x, y, p.x, p.y);;
//                                     myBest.score = score;
//                                     alpha = score;
//                                 } else if ((side == opponentColor) && (score < myBest.score)){
//                                     myBest.move = new Move(x, y, p.x, p.y);
